...
<body>
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo me-5" href="index.html"><img src="{{ url('/') }}/DashboardResources/images/logo.svg" class="me-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ url('/') }}/DashboardResources/images/logo-mini.svg" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="messageDropdown">
              ...
              <a class="dropdown-item">
                <div class="item-thumbnail">
                    <img src="{{ url('/') }}/DashboardResources/images/faces/face4.jpg" alt="image" class="profile-pic">
                </div>
              ...
              <a class="dropdown-item">
                <div class="item-thumbnail">
                    <img src="{{ url('/') }}/DashboardResources/images/faces/face2.jpg" alt="image" class="profile-pic">
                </div>
                <div class="item-content flex-grow">
              ...
              <a class="dropdown-item">
                <div class="item-thumbnail">
                    <img src="{{ url('/') }}/DashboardResources/images/faces/face3.jpg" alt="image" class="profile-pic">
                </div>
                <div class="item-content flex-grow">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
              <img src="{{ url('/') }}/DashboardResources/images/faces/face28.jpg" alt="profile"/>
            </a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      @include('Dashboards.SuperAdminDash.layout.nav')
      <!-- partial -->
